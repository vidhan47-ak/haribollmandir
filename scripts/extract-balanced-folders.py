...
folders = [
    ...
    ("folder_06", "https://drive.google.com/drive/folders/1635DEXXASeuqxHIrxQUOHS9hgE_wPt6H"),
    ("folder_07", "https://drive.google.com/drive/folders/1pWP3WTAg5RECZgAHs4Gxc0ISWk_UYo7d"),
    ("folder_08", "https://drive.google.com/drive/folders/1OIwY30EDAM3R1S185GK4XnrOHRV4Q9Ed"),
    ("folder_09", "https://drive.google.com/drive/folders/1J_eNLVimSrmkKjO9XppCvtwBiPZfWjAI"),
    ("folder_10", "https://drive.google.com/drive/folders/1LQZRtxD-o2PTzZQngrAeouaQKaf42t4K"),
]

base_dir = r"D:\haribolll\_gdrive_balanced"
os.makedirs(base_dir, exist_ok=True)

print(f"Fetching photos from all {len(folders)} Google Drive folders...")
...
for name, url in folders:
    ...
    try:
        gdown.download_folder(url, output=target_path, quiet=True, use_cookies=False)
    except Exception as e:
        print(f"Skipping error for {name}: {e}")

print("\nDone fetching balanced folders!")
